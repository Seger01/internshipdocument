...
\noindent \textbf{Services Offered:}
\begin{itemize} 
...
touchpad sensor to determine the position of the ball position. The system is controlled by an
...
accuracy and real-time capabilities of the platform. Topic now want to research the
...
Since the Miami board has more capabilities and hardware options Topic wants to explore explore these options and see which can be used to better the performance of the platform
...
The current project has two main problems that need to be addressed.
First, the touchpad sensor used to determine the ball's position introduces substantial latency, undermining the system's responsiveness and its ability to operate in real time with the necessary accuracy.
Second, by relying on an external STM32 microcontroller, the project does not take advantage of the advanced features available on the Topic Miami Plus ZU9 board. 
Transitioning to the Topic board would unlock a broader range of hardware and software solutions, enabling more effective strategies to reduce latency and enhance overall platform performance.


\subsection{Objective}

The goal of this project is to enhance the performance of the Stewart platform by leveraging the advanced hardware capabilities of the Topic Miami Plus ZU9 board. 
To achieve this, the project is divided into two main objectives, each focusing on a different aspect of the system's optimization.  

\textbf{Wouter's Objective:} This part of the project focuses on exploring the various hardware options available on the Topic Miami Plus ZU9 board, including the two real-time processors, the embedded Linux environment, and the GPU.  
The aim is to determine the most effective use of these resources for handling tasks such as acquiring video, determining ball position and speed, the ball movement control program, and overall system coordination.  
Additionally, this objective includes the design or integration of a user interface to control the system and visualize key data.  
The goal is to minimize latency while ensuring smooth integration between these processing units.  


\textbf{Seger's Objective:} This part of the project is centered on integrating the motor control system and machine vision program into the FPGA. 
In addition to offloading these time-sensitive processes to the FPGA to achieve real-time responsiveness and improve tracking accuracy, this objective also involves selecting and developing the most suitable communication strategies between the FPGA and the other system components.  

Together, these objectives will ensure that each component of the Stewart platform is assigned to the most suitable hardware resource, leading to a more efficient, responsive, and well-integrated system.


\subsection{Final Result}  
The final result of this project is a fully functional Stewart platform utilizing the Topic Miami Plus ZU9 board.  
The chosen architecture will be documented, providing an overview of the selected hardware configurations and communication strategies, along with a justification for these choices based on performance improvements and system requirements.  
The FPGA will be used to handle motor controle and other critical real-time processes, ensuring minimal latency and efficient system operation.  
The platform will feature a user interface for control, a display to visualize intermediate ball detection steps, and logging functionality to monitor system performance and behavior over time.  
This implementation will demonstrate the effectiveness of the chosen architecture in improving responsiveness, accuracy, and usability, ultimately creating the Stewart platform demonstation.  
...
\begin{center}
    ...
    \end{tabular} 
\end{center}
\caption{Table of people involved in the project}
\end{table}
\noindent \textbf{Meetings / communication}\\
...
\begin{table}[H]
\begin{longtable}{|l|p{0.4\textwidth}|p{0.3\textwidth}|}
    \hline
    ...
    1 (3-2-2025)  & Get to know the company, work on PoA and plan first meeting with academic supervisor & Have project clearly defined \\ \hline
    ...
    14 (19-5-2025) & Fabricating product and finishing first version of Qualification, Research and Design. This week is possibly the Colloquium. & Submit Research, Design, and Qualification for review \\ \hline
    15 (26-5-2025) & Work on finishing product and start testing by Qualification document. This week is possibly the Colloquium. & TBD \\ \hline
...
\begin{itemize}
    ...
    \item Intern colsultant: \euro 6400 (2 hours per week for 20 weeks)160 per hour so 3200 total.
\end{itemize}
\textbf{Hardware} \\ 
...
\begin{itemize} 
    ...
    \item 2 Miami devkit : \euro 8000
    \item Stewart platform: \euro 250
    \item Camera: \euro 60 
\end{itemize}
\textbf{Software}\\
...
\end{itemize}
This project has an additional budget of €1000 available for purchasing new components or supplementary items. 
Additional funding may be granted upon approval by Dirk van den Heuvel
\subsection{Benefits}
...
\section{References}
% \bibliographystyle{plain}  % or use "abbrv", "unsrt", or "apalike"
\printbibliography
