...
\newpage
\section{Risks (Seger)}
Risks are an important consideration when planning a project.
In this project there are two kind of risks which are technical risks and project management risks.
In this chapter I want to discuss the potential risks, how likely they are, how damaging they are and how they could be mitigated.

\subsection{Technical Risks}
\subsubsection{Project scope too large}
    There is a possibility that the project scope may be too large.
\subsubsection{Devkit problems}
The entire project is built, developed and ran on a devkit supplied to use by Topic and which was previously used by a different intership projects.

\subsubsection{Intergration complexity}
